...
def readColmapCameras(cam_extrinsics, cam_intrinsics, images_folder, objects_folder=None):
    cam_infos = []
...
def readColmapSceneInfo(path, images, eval, lod, llffhold=8, object_path=None):
    try:
