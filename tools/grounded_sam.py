...
# Grounding DINO utilities are required (from gaussian-grouping ext)
...
def grounded_sam_output(groundingdino_model, sam_predictor, TEXT_PROMPT, image, BOX_TRESHOLD = 0.3, TEXT_TRESHOLD = 0.45, device='cuda'):
    image_source = image
    transform = T.Compose(
        [
